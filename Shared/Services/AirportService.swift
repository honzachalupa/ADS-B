...
class AirportService: ObservableObject {
    ...
    private let airportData: [String: (name: String, lat: Double, lon: Double, country: String, iata: String?)] = [
        ...
        "UUEE": ("Moscow Sheremetyevo Airport", 55.9728, 37.4147, "RU", "SVO"),
        "UUDD": ("Moscow Domodedovo Airport", 55.4088, 37.9063, "RU", "DME"),
        "UUWW": ("Moscow Vnukovo Airport", 55.5914, 37.2615, "RU", "VKO"),
        "ULLI": ("St. Petersburg Pulkovo Airport", 59.8003, 30.2625, "RU", "LED"),
        "LTBA": ("Istanbul Atatürk Airport", 40.9769, 28.8169, "TR", "ISL"),
        "LTFM": ("Istanbul Sabiha Gökçen Airport", 40.8983, 29.3092, "TR", "SAW"),
        "LTFJ": ("Istanbul Airport", 41.2753, 28.7519, "TR", "IST"),
        "BIKF": ("Keflavík International Airport", 63.9850, -22.6056, "IS", "KEF"),
        "BKPR": ("Pristina International Airport", 42.5728, 21.0358, "XK", "PRN"),
        "LYBE": ("Belgrade Nikola Tesla Airport", 44.8184, 20.3091, "RS", "BEG"),
        "LBSF": ("Sofia Airport", 42.6968, 23.4114, "BG", "SOF"),
        "LROP": ("Bucharest Henri Coandă International Airport", 44.5722, 26.1020, "RO", "OTP"),
        "LUKK": ("Kyiv Boryspil International Airport", 50.3450, 30.8947, "UA", "KBP"),
        "EVRA": ("Riga International Airport", 56.9236, 23.9711, "LV", "RIX"),
        "EYVI": ("Vilnius Airport", 54.6341, 25.2858, "LT", "VNO"),
        "EETN": ("Tallinn Airport", 59.4133, 24.8328, "EE", "TLL"),
        ...
        "OMAA": ("Abu Dhabi International Airport", 24.4330, 54.6511, "AE", "AUH"),
        "OEJN": ("King Abdulaziz International Airport", 21.6790, 39.1225, "SA", "JED"),
        "OERK": ("King Khalid International Airport", 24.9576, 46.6988, "SA", "RUH"),
        "OTHH": ("Hamad International Airport", 25.2731, 51.6080, "QA", "DOH"),
        "OKBK": ("Kuwait International Airport", 29.2267, 47.9689, "KW", "KWI"),
        "OIIE": ("Imam Khomeini International Airport", 35.4162, 51.1522, "IR", "IKA"),
        "RKPC": ("Jeju International Airport", 33.5113, 126.4930, "KR", "CJU"),
        "RPLL": ("Ninoy Aquino International Airport", 14.5086, 121.0194, "PH", "MNL"),
        "WIII": ("Soekarno-Hatta International Airport", -6.1256, 106.6558, "ID", "CGK"),
        "WMKK": ("Kuala Lumpur International Airport", 2.7456, 101.7072, "MY", "KUL"),
